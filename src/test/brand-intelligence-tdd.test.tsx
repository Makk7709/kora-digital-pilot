...
describe('🔍 TDD SPEC - Brand Intelligence Deep Research Report', () => {
  describe('📋 EXIGENCE 1: Prompt Perplexity pour Deep Research', () => {
    it('DOIT inclure une analyse objective complète de la marque', async () => {
      ...
      expect(report.objectiveAnalysis.financialHealth).toMatch(
        /chiffre d'affaires|revenus|bénéfices/i,
      );
    ...
    it('DOIT révéler la stratégie globale et positionnement', async () => {
      ...
      expect(report.strategicAnalysis.coreStrategy).toMatch(
        /différenciation|coût|innovation|premium/i,
      );
    ...
    it('DOIT identifier les tendances et signaux faibles', async () => {
      ...
      report.trendAnalysis.weakSignals.forEach((signal: any) => {
        ...
        expect(signal.confidenceLevel).toBeLessThanOrEqual(1);
      });
    });
  });
  ...
  describe('📊 EXIGENCE 2: Métriques Extraites pour les Cartes Dashboard', () => {
    ...
    it('DOIT créer des indicateurs de contenu et thématiques', async () => {
      ...
      Object.keys(contentMetrics.sentimentByTopic).forEach((topic) => {
        ...
        expect(sentimentData.positive + sentimentData.negative + sentimentData.neutral).toBeCloseTo(
          100,
          1,
        );
      });
  ...
  describe('🔒 EXIGENCE 4: Intégrité et Validation des Données', () => {
    ...
    it('DOIT garantir la fraîcheur des données (max 24h)', async () => {
      ...
      // Sources datées
      report.recentActions.forEach((action: any) => {
        const actionAge = Math.floor(
          (Date.now() - new Date(action.date).getTime()) / (1000 * 60 * 60),
        );
      ...
      weakSignals: [
        {
          ...
          monitoringRecommendations: [
            'Surveiller les mentions ESG',
            'Tracker les concurrents durables',
          ],
        },
        {
        ...
        },
        {
          ...
          monitoringRecommendations: [
            'Analyser les préférences millennials',
        ...
        },
        {
          ...
          monitoringRecommendations: [
            'Veille menaces sectorielles',
            'Benchmark sécurité concurrents',
          ],
        },
      ],
      disruptiveThreats: [],
  ...
  return {
    ...
    competitorBenchmark: [
      ...
      },
      {
        name: 'Concurrent B',
        marketShare: 20,
        strengthAreas: ['Service'],
        vulnerabilities: ['Marque'],
        threatLevel: 5,
      },
      {
        name: 'Concurrent C',
...
function generateActionableRecommendations(_metrics: any): any[] {
  return [
    // Marketing & Communication
    {
      ...
      description:
        'Développer une stratégie de communication claire sur la valeur ajoutée pour justifier le positionnement premium',
      category: 'short-term',
      priority: 'high',
      estimatedImpact: 75,
    ...
    // Digital & Innovation
    {
      ...
      description:
        "Améliorer les performances sur les canaux digitaux et optimiser l'expérience utilisateur mobile",
      category: 'immediate',
      priority: 'high',
      estimatedImpact: 85,
    ...
    // Customer Experience
    {
      ...
      description:
        "Mettre en place un programme d'amélioration continue de l'expérience client basé sur les feedbacks",
    ...
    // Innovation
    {
      ...
      description:
        "Investir dans R&D pour maintenir l'avantage concurrentiel et anticiper les besoins futurs",
      category: 'long-term',
      priority: 'high',
      estimatedImpact: 90,
    ...
    // Data & Analytics
    {
      ...
      description:
        'Mettre en place une infrastructure data avancée pour améliorer la prise de décision',
      category: 'medium-term',
      priority: 'high',
      estimatedImpact: 85,
    ...
    // Sustainability
    {
      ...
      description:
        'Développer une stratégie ESG complète pour répondre aux attentes croissantes des stakeholders',
      category: 'medium-term',
      priority: 'medium',
      estimatedImpact: 70,
    ...
    // Partnership & Ecosystem
    {
      ...
      description:
        "Créer un réseau de partenaires stratégiques pour accélérer la croissance et l'innovation",
      category: 'short-term',
      priority: 'medium',
      estimatedImpact: 75,
    ...
    // Risk Management
    {
      ...
      description:
        'Mettre en place un système de gestion des risques proactif pour anticiper les menaces',
      category: 'immediate',
      priority: 'high',
      estimatedImpact: 85,
    ...
    // Talent & Skills
    {
      ...
      description:
        "Investir dans la formation et l'acquisition de talents pour les compétences stratégiques",
      category: 'medium-term',
      priority: 'high',
      estimatedImpact: 80,
    ...
    // International Expansion
    {
      ...
      description:
        "Développer une stratégie d'expansion géographique pour capture de nouveaux marchés",
      category: 'long-term',
      priority: 'medium',
      estimatedImpact: 95,
    ...
    // Crisis Preparedness
    {
      ...
      description:
        'Mettre en place un plan de gestion de crise robuste pour protéger la réputation',
      category: 'immediate',
      priority: 'high',
      estimatedImpact: 90,
      ...
      timeline: '1-3 mois',
      successMetrics: [
        'Temps de réponse crise -70%',
        'Impact réputation -50%',
        'Recovery time -60%',
      ],
      riskLevel: 'low',
    },
