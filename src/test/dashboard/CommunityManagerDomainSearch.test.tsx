...
describe('🏢 DASHBOARD COMMUNITY MANAGER - RECHERCHE DOMAINE', () => {
  ...
  describe('🔍 INTERFACE DE RECHERCHE', () => {
    ...
    it('DOIT afficher le champ de recherche principal', () => {
      ...
      expect(searchInput).toHaveAttribute('placeholder', expect.stringContaining('Intelligence Artificielle'));
    });
    ...
    it('DOIT valider les entrées de recherche', async () => {
  ...
  describe('📊 AFFICHAGE DES RÉSULTATS EN CARTES', () => {
    ...
    it('DOIT permettre l\'interaction avec les cartes', async () => {
      mockSearchService.currentResult = mockDomainData;
      const user = userEvent.setup();
  ...
  describe('🔄 GESTION D\'ÉTAT ET PERFORMANCE', () => {
    ...
    it('DOIT afficher un loader pendant la recherche', async () => {
    ...
    it('DOIT mémoriser les recherches récentes', async () => {
  ...
  describe('📱 RESPONSIVE ET ACCESSIBILITÉ', () => {
    ...
    it('DOIT supporter la navigation au clavier', async () => {
      render(<CommunityManagerDomainDashboard />);
