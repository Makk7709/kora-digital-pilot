          ...
          <Card className="premium-card">
            ...
            <CardContent className="space-y-4">
              ...
              <div>
                ...
                <select className="w-full bg-white border border-slate-200 rounded-lg p-2 text-slate-700 text-sm focus:border-blue-500 focus:ring-1 focus:ring-blue-500">
                  {tones.map((tone) => (
            ...
            <CardContent className="p-4">
              <div className="flex items-center space-x-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-slate-500 text-xs">Assistante IA</p>
                </div>
              </div>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Button 
                  ...
                  className="bg-gradient-to-r from-blue-500 to-sky-500 hover:from-blue-600 hover:to-sky-600 text-white shadow-lg hover:shadow-xl transition-all duration-300"
                >
                  {isGenerating ? (
                    <>
            ...
            <Card className="premium-card">
              <CardContent className="p-6">
                <div className="flex items-center space-x-3 mb-4">
                  ...
                  <span className="text-blue-600 font-medium">Kora travaille sur votre contenu...</span>
                </div>
          ...
          {!isGenerating && prompt && (
            <div className="space-y-4">
              {selectedPlatforms.map((platformId) => {
                ...
                return (
                  <Card key={platformId} className="premium-card">
                    <CardHeader>
                    ...
                    <CardContent className="space-y-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <div className="flex space-x-2">
                          ...
                          <Button size="sm" className="bg-gradient-to-r from-blue-500 to-sky-500 hover:from-blue-600 hover:to-sky-600 text-white">
                            📋 Copier
                          </Button>
                        </div>
                      </div>
