...
vi.mock('../CompanyAnalysisWidget', () => ({
  CompanyAnalysisWidget: () => <div data-testid="company-analysis-widget">Company Analysis Widget</div>
}));
...
describe('🚀 ENHANCED BRAND MONITORING - TESTS TDD PREMIUM', () => {
  ...
  describe('📱 Structure et Rendu Initial', () => {
    ...
    it('⭐ DOIT marquer les fonctionnalités premium avec des étoiles', () => {
      render(<EnhancedBrandMonitoring />);
    ...
    it('🏆 DOIT afficher les badges appropriés', () => {
      render(<EnhancedBrandMonitoring />);
  ...
  describe('📊 Vue d\'Ensemble - Hero Section', () => {
    ...
    it('📝 DOIT afficher la description du service', () => {
      ...
      expect(screen.getByText(/Analysez votre société, surveillez vos concurrents/)).toBeInTheDocument();
    });
  ...
  describe('✨ Features Grid', () => {
    it('🤖 DOIT afficher "IA Perplexity Intégrée"', () => {
      ...
      expect(screen.getByText('Analyses alimentées par l\'intelligence artificielle')).toBeInTheDocument();
    });
  ...
  describe('⚙️ Modes d\'Analyse', () => {
    ...
    it('🏢 DOIT décrire l\'Analyse de Société', () => {
      render(<EnhancedBrandMonitoring />);
    ...
    it('🎯 DOIT décrire la Surveillance Concurrentielle', () => {
      render(<EnhancedBrandMonitoring />);
    ...
    it('🛡️ DOIT décrire le Suivi de Réputation', () => {
      render(<EnhancedBrandMonitoring />);
    ...
    it('👆 DOIT permettre de cliquer sur les modes pour naviguer', async () => {
      render(<EnhancedBrandMonitoring />);
      
      // Cliquer sur Analyse de Société dans la vue d'ensemble
      const analysisCard = screen.getByText('Analyse de Société').closest('div[role="button"], button, [data-testid*="card"]')?.parentElement;
      if (analysisCard) {
  ...
  describe('📑 Contenu des Onglets', () => {
    it('🏢 DOIT afficher le titre "Analyse de Société" dans l\'onglet', async () => {
      render(<EnhancedBrandMonitoring />);
      ...
      expect(screen.getByText('Analyse de Société')).toBeInTheDocument();
      expect(screen.getByText('Analysez votre entreprise avec l\'IA Perplexity')).toBeInTheDocument();
    });

    it('🎯 DOIT afficher le titre "Surveillance Concurrentielle" dans l\'onglet', async () => {
      render(<EnhancedBrandMonitoring />);
    ...
    it('🛡️ DOIT afficher le contenu "Module en Développement"', async () => {
      ...
      expect(screen.getByText('Module en Développement')).toBeInTheDocument();
      expect(screen.getByText('Le module de suivi de réputation sera bientôt disponible avec :')).toBeInTheDocument();
    });
  ...
  describe('🔘 Boutons d\'Action', () => {
    ...
    it('🎯 DOIT déclencher la navigation vers Surveillance depuis le hero', async () => {
      ...
      await waitFor(() => {
        expect(screen.getByTestId('tab-competitive-monitoring')).toHaveAttribute('data-state', 'active');
      });
    });
