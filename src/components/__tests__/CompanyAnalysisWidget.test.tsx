...
const MOCK_DEEP_REPORT: DeepResearchReport = {
  ...
  reputationKPIs: {
    ...
    crisisResilience: 85,
    competitorComparison: [{ competitor: 'Ford', ourScore: 87, theirScore: 65, gap: 22 }],
  },
  recommendations: [
    {
      id: 'rec-001',
...
describe.skip('🏢 COMPANY ANALYSIS WIDGET - TESTS TDD PREMIUM', () => {
  ...
  describe('📱 Structure et Rendu Initial', () => {
    ...
    it('📝 DOIT afficher la description du service', () => {
      ...
      expect(
        screen.getByText(/Analysez votre société avec l'intelligence artificielle Perplexity/),
      ).toBeInTheDocument();
    });
  });
