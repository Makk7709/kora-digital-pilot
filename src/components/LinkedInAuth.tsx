  ...
  return (
    <Card className="premium-card">
      ...
      <CardContent className="p-6">
        {/*
         * S7735 : on remplace les ternaires `!cond ?` imbriqués par un
         * discriminant `stage` explicite, plus lisible.
         */}
        {(() => {
          type Stage = 'demo' | 'login' | 'connected';
          let stage: Stage;
          if (isConfigured) {
            stage = isAuthenticated ? 'connected' : 'login';
          } else {
            stage = 'demo';
          }
          return (
                ...
                <div className="text-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm mb-4">
                      LinkedIn n'est pas configuré. L'application fonctionne avec des données
                  ...
                  <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 text-left">
                    ...
                    <ol className="text-blue-700 text-sm space-y-1">
                      <li>
                        1. Créez un fichier <code className="bg-blue-100 px-1 rounded">.env</code> à
                        la racine
                      </li>
                      <li>
                        2. Ajoutez{' '}
              ...
              {stage === 'login' && (
                <div className="text-center space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-600 text-sm mb-4">
                      Accédez à vos vraies métriques de performance et obtenez des insights
                      personnalisés basés sur vos données réelles.
                    </p>
                  </div>
