...
>({
  ...
  // S6481 : on mémoïse pour éviter le re-render de chaque consumer à chaque render parent.
...
const FormItem = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(
  ({ className, ...props }, ref) => {
    ...
    // S6481 : mémoïsation pour stabiliser la référence de l'objet exposé via le Provider.
