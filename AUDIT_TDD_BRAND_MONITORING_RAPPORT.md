...
1. ✅ **Fixer le hook useHybridAI** 
   - Ajouter vérification null safety pour `perplexity.cacheStats.size`
   - Implémenter fallback values
...
|----------|----------|---------|--------------|
| 🔥 **P0** | useHybridAI crash | App inutilisable | 15 min |
| 🔥 **P0** | Serveur dev | App inaccessible | 5 min |
| ⚠️ **P1** | Navigation sidebar | UX dégradée | 10 min |
| ⚠️ **P1** | Test assertions | CI/CD cassé | 10 min |
