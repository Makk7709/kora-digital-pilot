...
### Étape 1: Lancement Application (30 secondes)
```bash
cd kora-digital-pilot
npm run dev
```
✅ **L'application devrait démarrer sur http://localhost:8088**

### Étape 2: Navigation Interface (1 minute)
1. **Ouvrir** : http://localhost:8088/app
2. **Cliquer** : "Intelligence TDD 🚀" dans le menu sidebar
3. **Saisir** : "Nike" dans le champ marque
4. **Cliquer** : "Générer Deep Research"

### Étape 3: Validation Rapports (2 minutes)
Le dashboard affiche immédiatement **5 onglets riches** :

#### 📊 Vue d'ensemble
- ✅ Score de confiance : 85/100
- ✅ Score de réputation : 70-95/100 (variable)
...
#### 🏆 Concurrentiel
- ✅ Part de marché : 25.5%
- ✅ 3 concurrents analysés avec métriques
- ✅ Positionnement : Leader
- ✅ Évolution historique Q1-Q4 2023

#### 🎨 Contenu & Thèmes
- ✅ 5 thématiques analysées avec pourcentages
- ✅ 45K likes, 12K partages, 8.5K commentaires
...
#### 4. Intégrité Données ✅
- **Cohérence** : Validation cross-metrics
...
### Phase 3 : Finalisation 🎯 PROCHAINE
...
# Lancer tests TDD
npm test -- src/test/brand-intelligence-tdd.test.tsx
# Résultat attendu : 12/13 tests OK
```
