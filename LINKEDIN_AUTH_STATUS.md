...
- ✅ Serveur Vite configuré sur port 8088 avec `strictPort: true` - ✅ Serveur proxy configuré sur port 3001
...
- ✅ **Client ID vérifié** : `[REDACTED_CLIENT_ID]` - ✅ **Client Secret vérifié** : `WPL_AP1.[REDACTED]` - ✅ **Test confirmé** : LinkedIn accepte nos identifiants
...
### **À Vérifier :**
- **Application** : "CM KORA"
- **Client ID** : `[REDACTED_CLIENT_ID]` - **Redirect URI** : `http://localhost:8088/auth/linkedin/callback` - **Scopes** : `openid profile` ### **URL du Portal :**
